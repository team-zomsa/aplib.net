...
namespace Aplib.Core.Logging
{
    ...
    /// The only method that needs to be implemented in loggable classes is the GetLogChildren method;
    /// the structure of the log tree is generated automatically when calling the GetLogTree method.
    /// </summary>
    public interface ILoggable : IDocumented
    {
        ...
        /// </summary>
        /// <param name="depth">The depth of the this node in log tree.</param>
