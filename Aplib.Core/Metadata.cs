namespace Aplib.Core
{
    ...
    {
        /// <summary>
        /// The name used to display the component during debugging, logging, or general overviews.
        /// </summary>
        public string Name { get; }

        /// <summary>
        /// The description used to describe the component during debugging, logging, or general overviews.
        /// </summary>
        public string? Description { get; }

        /// <summary>
        /// Store information about a goal which may be useful for debugging or logging or general overviews.
        /// </summary>
